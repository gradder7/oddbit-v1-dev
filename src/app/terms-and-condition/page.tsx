  ...
  return (
    <>
      <div className="container-Policy">
        ...
        >
          <h2>Terms and Conditions for Oddbit</h2>
          <p>
            Welcome to Oddbit! These terms and conditions outline the rules and
            regulations for the use of oddbit&apos;s Website, located at
            https://oddbit.one and https://www.oddbit.one By accessing this
            website we assume you accept these terms and conditions. Do not
            continue to use oddbit if you do not agree to take all of the terms
            and conditions stated on this page. The following terminology
            applies to these Terms and Conditions, Privacy Statement and
            Disclaimer Notice and all Agreements: &rdquo;Client&rdquo;,
            &rdquo;You&rdquo; and &rdquo;Your&rdquo; refers to you, the person
            log on this website and compliant to the Company’s terms and
            conditions. &rdquo;The Company&rdquo;, &rdquo;Ourselves&rdquo;,
            &rdquo;We&rdquo;, &rdquo;Our&rdquo; and &rdquo;Us&rdquo;, refers to
            our Company. &rdquo;Party&rdquo;, &rdquo;Parties&rdquo;, or
            &rdquo;Us&rdquo;, refers to both the Client and ourselves. All terms
          ...
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By accessing oddbit, you agreed to use
            cookies in agreement with the oddbit&apos;s Privacy Policy. Most
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, oddbit and/or its licensors own the
            intellectual property rights for all material on oddbit. All
            intellectual property rights are reserved. You may access this from
            oddbit for your own personal use subjected to restrictions set in
            these terms and conditions. You must not: Republish material from
            oddbit Sell, rent or sub-license material from oddbit Reproduce,
            duplicate or copy material from oddbit Redistribute content from
            oddbit This Agreement shall begin on the date hereof. Parts of this
            website offer an opportunity for users to post and exchange opinions
            and information in certain areas of the website.oddbit does not
            ...
            oddbit,its agents and/or affiliates. Comments reflect the views and
            opinions of the person who post their views and opinions. To the
            extent permitted by applicable laws, oddbitshall not be liable for
            ...
            appearance of the Comments on this website. oddbit reserves the
            ...
            activities or unlawful activity. You hereby grant oddbit a
          ...
          <p>
            ...
            sources; dot.one community sites; associations or other groups
            ...
            compensates the absence ofoddbit; and (d) the link is in the context
            of general resource information. These organizations may link to our
            ...
            oddbit. Please include your name, your organization name, contact
            ...
            of our Website being linked to that makes sense within the context
            and format of content on the linking party&apos;s site. No use of
            oddbit&apos;s logo or other artwork will be allowed for linking
