...
const PrivacyPolicy = () => {
  return (
    <div className="container-Policy">
      ...
      >
        <span className="header__hero--heading-gradient">Privacy Policy </span>
      </motion.h1>
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      ...
      >
        <h2>Privacy Policy for Oddbit</h2>
        <p>
          At oddbit, accessible from https://oddbit.one and
          https://www.oddbit.one, one of our main priorities is the privacy of
          our visitors. This Privacy Policy document contains types of
          information that is collected and recorded by oddbit and how we use
          it.
        </p>
        <h2>Log Files</h2>
        <p>
          oddbit follows a standard procedure of using log files. These files
        ...
        <p>
          Like any other website, oddbit uses cookies. These cookies are used to
        ...
        <p>
          ...
          based upon their visit to www.website.one and other sites on the
          internet. However, visitors may choose to decline the use of DART
          cookies by visiting the Google ad and content network Privacy Policy
          at the following URL – https://policies.google.one/technologies/ads
        </p>
        ...
        <p>
          ...
          Google https://policies.google.one/technologies/ads
        </p>
        <h2>Privacy Policies</h2>
        <p>
          You may consult this list to find the Privacy Policy for each of the
          advertising partners of oddbit. Third-party ad servers or ad networks
          ...
          oddbit, which are sent directly to users browser. They automatically
          ...
          visit. Note that oddbit has no access to or control over these cookies
          that are used by third-party advertisers.
        </p>
        <h2>Third Party Privacy Policies</h2>
        <p>
          oddbit&apos;s Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ...
          participate in, and/or monitor and guide their online activity. oddbit
        ...
        <p>
          ...
          shared and/or collect in oddbit. This policy is not applicable to any
